...
export const registerUser = async (req: Request<{}, ApiResponse<{ user: UserResponse }>, RegisterRequest>, res: Response): Promise<void> => {
...
export const loginUser = async (req: Request<{}, ApiResponse<{ user: UserResponse }>, LoginRequest>, res: Response): Promise<void> => {
